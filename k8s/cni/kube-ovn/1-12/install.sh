...
SVC_CIDR_IPV4="10.96.0.0/12"
SVC_CIDR_IPV6="fd00:10:96::/112"
JOIN_CIDR_IPV4="100.64.0.0/16"
JOIN_CIDR_IPV6="fd00:100:64::/112"

POD_CIDR="$POD_CIDR_IPV4"                # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY="$POD_GATEWAY_IPV4"
SVC_CIDR="$SVC_CIDR_IPV4"                # Do NOT overlap with NODE/POD/JOIN CIDR
JOIN_CIDR="$JOIN_CIDR_IPV4"              # Do NOT overlap with NODE/POD/SVC CIDR
...
if [ "$IPV6" = "true" ]; then
  POD_CIDR="$POD_CIDR_IPV6"                # Do NOT overlap with NODE/SVC/JOIN CIDR
  POD_GATEWAY="$POD_GATEWAY_IPV6"
  SVC_CIDR="$SVC_CIDR_IPV6"               # Do NOT overlap with NODE/POD/JOIN CIDR
  JOIN_CIDR="$JOIN_CIDR_IPV6"              # Do NOT overlap with NODE/POD/SVC CIDR
  PINGER_EXTERNAL_ADDRESS="2400:3200::1"
  PINGER_EXTERNAL_DOMAIN="google.com."
fi
if [ "$DUAL_STACK" = "true" ]; then
  POD_CIDR="$POD_CIDR_IPV4,$POD_CIDR_IPV6"                # Do NOT overlap with NODE/SVC/JOIN CIDR
  POD_GATEWAY="$POD_GATEWAY_IPV4,$POD_GATEWAY_IPV6"
  SVC_CIDR="$SVC_CIDR_IPV4,$SVC_CIDR_IPV6"               # Do NOT overlap with NODE/POD/JOIN CIDR
  JOIN_CIDR="$JOIN_CIDR_IPV4,$JOIN_CIDR_IPV6"             # Do NOT overlap with NODE/POD/SVC CIDR
